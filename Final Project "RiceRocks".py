...
soundtrack = simplegui.load_sound("https://dl.dropbox.com/s/ufp49dj57hmews8/Dragon%20Ball%20Z%20Budokai%203%20Theme%20Song%20Japanese%20Version.ogg?dl=0")
...
class Sprite:
    ...
    def draw(self, canvas):
        if self.animated == True:
            ...
            current_explosion_center = [self.image_center[0] + explosion_index*self.image_size[0],
                                        self.image_center[1]]
...
def click(pos):
    global started, lives, collisions, number_of_games
...
def group_collide(group, other_object):
    ...
    for sprite in set(group):
        if sprite.collide(other_object):
            new_explosion = Sprite(sprite.get_position(), [0, 0], 0, 0, explosion_image, explosion_info)
...
def rock_spawner():
    ...
    if len(rock_group)<12 and started:
        ...
        while dist(my_ship.get_position(), rock_pos) < 100:
            rock_pos = [random.randrange(0, WIDTH), random.randrange(0, HEIGHT)]
